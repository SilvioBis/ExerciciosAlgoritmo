...
var dolar = parseFloat(prompt("Digite a valor em DOLAR disponivel: ")) ;
var dollarcot = parseFloat(prompt("Digite a Cotaçao Atual do Dollar: "));
var convert = (dolar * dollarcot);

alert("Voce tem disponivel $" + convert );
